...
Cada extensão Joomla requer um arquivo de manifesto. Ele é usado pelo Joomla para instalar arquivos nos locais corretos e executar outras tarefas durante a instalação ou remoção.

Consulte a seção [Arquivos de Manifesto](jdocmanual?article=docus/install-update/installation-manifest) da Documentação para Programadores do Joomla! para mais informações.

O código a seguir mostra o arquivo de manifesto para o componente **Contatos** (com_contact) como exemplo:
